          ...
          <div class="x_panel">
            ...
            <div class="x_content"></div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama" value="{{auth::user()->name}}"><span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
              </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" class="form-control" name="alamat" value="{{auth::user()->alamat}}"><span class="fa fa-map form-control-feedback right" aria-hidden="true"></span>
              </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control"  name="mapel" value="{{auth::user()->email}}"><span class="fa fa-book form-control-feedback right" aria-hidden="true"></span>
                </div>          
              </div>
              ...
              <div class="form-group">
                ...
                <button class="btn btn-primary" href="{{URL::to('index.user')}}">Cancel</button>
