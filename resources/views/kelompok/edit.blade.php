@extends('layouts.master') @section('title','Kelompok') @section('content')
            ...
            <div class="x_content">
              <br />
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  value= "{{$kelompok->nama_kelompok }}" name="nama_kelompok">
                ...
                <div class="form-group">
                  <div class="col-md-9 col-md-offset-3">
                    <button class="btn btn-primary" href="{{url('admin/kelompok')}}">Cancel</button>
